...
A graph can be used to represent a classification between elements (link:https://hal.archives-ouvertes.fr/hal-01526540/document[here] for more informations, _Philippe Vincke. La modélisation des préférences. [Rapport de recherche] Institut de mathématiques économiques (IME). 1985, 24 p., figures, bibliographie. ffhal-01526540_).
