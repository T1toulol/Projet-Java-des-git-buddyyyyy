...
|A string of the format "Alternative1,Alternative2,Alternative3..." is given as an argument to the method and it returns an Preference (OldLinearPreferenceImpl).
|Ok
