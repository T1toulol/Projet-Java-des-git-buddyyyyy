...
_(*) Be carefull, currently the asGraph() method of the Preference interface returns a Graph. We can't be sure that the returned graph is oriented, and therefore be a good representation of the preference._
----
