...
Lucas and Maxime => Poursuite des PR #29, #30, #31 : https://github.com/oliviercailloux-org/projet-j-voting/pull/29
...
- Correction du contrat de getAlternatives.
- Modification de la méthode getAlternatives qui renvoie un NavigableSet.
