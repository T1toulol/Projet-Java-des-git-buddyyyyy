...
- Permettre de visualiser les fichiers soc avec plusieurs votes
- Changement d'un texte en label et de l'affichage des alternatives
...
- Modification de la méthode getAlternatives de MutablePreference pour renvoyer un NavigableSet.
- Modifier les tests unitaires de addEquivalence et setAtLeastAsGood.
