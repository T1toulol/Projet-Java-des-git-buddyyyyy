...
Hugo and Chahid => Corrections demandées dans la PR #33 : https://github.com/oliviercailloux-org/projet-j-voting/pull/33
...
Lucas and Maxime => Corrections demandées dans la PR 
