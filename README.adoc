...
Nicolas and Maxime => L’objectif principal de cette itération est de corriger les éléments de correction mis en évidence dans la PR #50 : 

https://github.com/oliviercailloux-org/projet-j-voting/pull/50

Le but est d’intégrer la fonction d’exportation au format DOT. 

Dans un second temps, ils souhaitent améliorer la méthode de vérification des ID d’ExportDot initiée dans la PR #52 :

https://github.com/oliviercailloux-org/projet-j-voting/pull/52 

=== Duo 2 and tasks

Firas and Chahid => Mise en place d’un fonctionnement basique pour le GUI avec visualisation de voteurs multiples et correction des alternatives (suite de la PR # 49): 

https://github.com/oliviercailloux-org/projet-j-voting/pull/49

Pour être plus précis, ils vont effectuer les modifications suivantes :

- Première tâche: Permettre de visualiser les fichiers soc avec plusieurs votes
- Deuxième tâche: Changement d'un texte en label et de l'affichage des alternatives

=== Duo 3 and tasks

Lucas and Sylvain => Poursuite des PR #47 et #51 : 

https://github.com/oliviercailloux-org/projet-j-voting/pull/47

https://github.com/oliviercailloux-org/projet-j-voting/pull/51

Dans un premier temps, ils veulent poursuivre la PR #51 avec les tâches suivantes:

- Première tâche: Modification de la méthode getAlternatives de MutablePreference pour renvoyer un NavigableSet.
- Deuxième tâche: Modifier les tests unitaires de addEquivalence et setAtLeastAsGood.

Dans un second temps, ils pousuivront la PR # 47 avec les tâches suivantes:

- Modifier la méthode swap
