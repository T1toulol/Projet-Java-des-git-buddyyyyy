 ...
 * The DOT format is a simple file format which describes graphs. This type of
 * file is used by graph visualization applications. For more details about DOT
 * format: https://www.graphviz.org/doc/info/lang.html
 */
...
public class ExportDot {
	...
	/**
	 * Calls the export method with the parameter lineSeparator. By default the end
	 * of line encoding is given by System.lineSeparator().
	 * 
	 ...
	 * (with UTF-8 character encoding) it to the stream from the parameters (which
	 * is given to the streamExport attribute of ExportDOT class). This choice is
	 * based on René Nyffenegger examples
	 * (https://renenyffenegger.ch/notes/tools/Graphviz/examples/index) referenced
	 * in the official website about DOT format
	 * (https://www.graphviz.org/resources/#simple-examples-and-tutorials).
	 * 
	 * You can chose the end of line encoding (CR / CRLF / LF format) by the string
	 * lineSeparator given.
	 * 
	 * @param graph         can't be null
	 * @param stream        can't be null
	...
	/**
	 * This method allowed to write the string given to the output stream in the
	 * streamExport attribute of the ExportDOT class.
	 * 
	 * @param str
	 * @throws IOException
	 */
	...
	/**
	 * This method allowed to write the string given to the output stream in the
	 * streamExport attribute of the ExportDOT class. We must to define the end of
	 * line encoding. An indentation and an end of line are added to match the DOT
	 * format, for writing vertices and arcs/edges.
	 * 
	 * @param str
	 * @param lineSeparator
	 * @throws IOException
	 ...
	 * This method allowed to write the string given to the output stream in the
	 * streamExport attribute of the ExportDOT class. We must to define the end of
	 * line encoding. The header in DOT format have no indentation & end of line.
	 * 
	 * @param headerDot
	 * @param lineSeparator
	 * @throws IOException
	...
	/**
	 * Calls the convertToDot method only with the graph in parameter By default the
	 * end of line encoding is given by System.lineSeparator().
	 * 
	...
	/**
	 * Takes the graph and convert it to a DOT format String with the end of line
	 * encoding chosen (in CR / CRLF / LF format). For more informations about DOT
	 * format: <a href="http://www.graphviz.org/doc/info/lang.html">GraphViz
	 * website</a>.
	 * 
	 * @param a string graph
	 * @return the graph in DOT format
	...
	/**
	 * This method is greatly inspired from the method getVertexId of the
	 * DOTExporter<V,E> class. For more informations: <a href=
	 * "https://jgrapht.org/javadoc-1.1.0/org/jgrapht/ext/DOTExporter.html">DOTExporter</a>.
	 * 
		...
		for (String aNode : myNodes) {
			...
			if (!isAlphaDig && !isDotNumber && !isDoubleQuoted && !isHtml) {
				throw new IllegalArgumentException(
						"The name of atleast one vertex can't be converted in DOT format : " + aNode);
			}
		}
	}

	/**
	 * This enum class gives all lines separators (CRLF, CR, LF) that can be
	 * accepted in DOT format.
	 */
